...
namespace codicastudio\MultiselectField;
...
class FieldServiceProvider extends ServiceProvider
{
    ...
    protected function translations()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__ . '/../resources/lang' => resource_path('lang/vendor/multi-select')], 'translations');
    ...
    protected function attemptToLoadTranslations($locale, $from)
    {
        $filePath = $from === 'local'
            ...
            : resource_path('lang/vendor/multi-select') . '/' . $locale . '.json';
